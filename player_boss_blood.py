...
while True:
    ...
    # battle_screen_shot = np.array(screen_capture.grab_screen(battle_area))
    # grayscale_img_battle = cv2.cvtColor(battle_screen_shot, cv2.COLOR_RGB2GRAY)
    # cv2.imshow('Gray image', grayscale_img_battle)
