...
if __name__ == '__main__':
    ...
    while True:
        ...
        detect_window_gray = cv2.cvtColor(np.array(screen_capture.grab_screen(self_blood_area)), cv2.COLOR_RGB2GRAY)
        # count_100 = 0
        for pixel in detect_window_gray[0]:
            print(pixel)


        player_blood = count_player_blood(detect_window_gray)
